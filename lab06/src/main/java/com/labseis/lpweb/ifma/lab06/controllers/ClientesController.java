...
public class ClientesController {
    ...
    @PostMapping
    public ResponseEntity<Clientes> criarCliente(@RequestBody Clientes clientes, HttpServletResponse response) {
        Clientes clienteSalvo = service.save(clientes);

        publisher.PublishEvent(new HeaderLocationEvento(this, response, clientes.getId()));
